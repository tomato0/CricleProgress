...
public class CircleProgressView extends View {
    ...
    private void setAttributes(Context context, TypedArray typedArray) {
        //r
        mRadius = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_radius, UnitUtils.dpToPx(100,context));
        //progress width
        mStripeWidth = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_stripeWidth, UnitUtils.dpToPx(20, context));
        //text size
        mTxtSize1 = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_textSizeOne, UnitUtils.spToPx(20, context));
        mTxtSize2 = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_textSizeTwo, UnitUtils.spToPx(20, context));
        mTxtSize3 = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_textSizeThree, UnitUtils.spToPx(20, context));
        //color
